...
// LoD2 TÜV Only
const TUVtilesetLOD2= await Cesium.Cesium3DTileset.fromIonAssetId(2663459);
viewer.scene.primitives.add(TUVtilesetLOD2);



TUVtilesetLOD2.style = new Cesium.Cesium3DTileStyle({
    show: {
        conditions: [
            ["${Height} === 21.057363068776468", "true"],
            ["${Height} === 17.638531342038092", "true"],
            ["${Height} === 19.71697910877323", "true"],
            ["${Height} === 8.27511435794878", "true"],
            ["${Height} === 6.404158458170514", "true"],
            ["${Height} === 3.1053009679756087", "true"],
            ["${Height} === 4.7372055708840435", "true"],
            ["${Height} === 3.6773117411227076", "true"],
            ["${Height} === 2.6401405746011193", "true"],
            ["${Height} === 8.559914425509533", "true"],
            ["${Height} === 3.5555567227366964", "true"],
            ["${Height} === 2.7300640183191547", "true"],
            ["${Height} === 42.13942282102829", "true"],
            ["true", "false"] // Default: Hide everything else
        ]
    }
});
...
//LoD2 TÜV only
document.getElementById('TUVtilesetLOD2CheckBox').addEventListener('change', () => {
    TUVtilesetLOD2.show = !TUVtilesetLOD2.show;
    });
      //Trees
